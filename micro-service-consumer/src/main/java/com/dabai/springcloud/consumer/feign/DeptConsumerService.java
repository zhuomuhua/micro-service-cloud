...
import com.dabai.springcloud.consumer.feign.fallback.DeptConsumerServiceImpl;
 ...
 **/
@FeignClient(name = "micro-service-provider", fallback = DeptConsumerServiceImpl.class, configuration = FeignConfiguration.class)
